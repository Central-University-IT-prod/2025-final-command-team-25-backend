"""change enum to standard2

Revision ID: 2f999816de8c
Revises: 72f7dbfe324c
Create Date: 2025-03-03 04:48:52.375347
...
revision: str = '2f999816de8c'
down_revision: Union[str, None] = '72f7dbfe324c'
...
old_enum_name = 'accesslevel1' # Замените на имя вашего старого enum типа
new_enum_name = 'accesslevel'

old_options = ('GUEST', 'STANDARD', 'PRO') # Получите старые опции enum, если это необходимо. Если нет, оставьте None
new_options = ('GUEST', 'STANDARD', 'PRO')
