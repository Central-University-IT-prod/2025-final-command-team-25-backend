"""change enum to standard

Revision ID: 72f7dbfe324c
Revises: 6bcad01dd26e
Create Date: 2025-03-03 04:42:40.680454
...
revision: str = '72f7dbfe324c'
down_revision: Union[str, None] = '6bcad01dd26e'
...
new_enum_name = 'accesslevel1'

old_options = ('GUEST', 'STANDART', 'PRO') # Получите старые опции enum, если это необходимо. Если нет, оставьте None
